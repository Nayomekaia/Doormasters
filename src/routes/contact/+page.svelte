...
<style>
	...
	.new-form-btn { display:flex; align-items:center; gap:.5rem; background:white; border:2px solid var(--color-blue-dark); color:var(--color-blue-dark); padding:.75rem 1.75rem; border-radius:8px; font-size:.9375rem; font-weight:600; cursor:pointer; transition:all .2s ease; }
	...
	/* SUBMIT BUTTON */
	.submit-btn { display:flex; align-items:center; justify-content:center; gap:.625rem; background:linear-gradient(135deg,var(--color-blue-dark)0%,#1e3a5f 100%); color:white; border:none; padding:1rem 3rem; border-radius:8px; font-size:1rem; font-weight:700; letter-spacing:.5px; cursor:pointer; transition:all .3s ease; box-shadow:0 4px 12px rgba(0,0,0,.2); min-width:200px; }
