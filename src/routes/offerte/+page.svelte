	...
	function handleEnhance() {
		...
		return async ({ result, update }) => {
			if (result.type === 'success') {
				formState = 'success';
				document
					.querySelector('.offerte-formulier')
					...
					<div class="success-checklist">
						<div class="check-item">
							<svg
								...
								stroke-linejoin="round"
								width="0.875rem"
								height="0.875rem"><polyline points="20 6 9 17 4 12" /></svg
							>
							<span  style="font-family: var(--font-primary);">Aanvraag ontvangen</span>
						</div>
						<div class="check-item">
							<svg
								viewBox="0 0 24 24"
				...
				<div class="form-body" class:form-loading={formState === 'loading'}>
					...
					<section class="formulier-sectie animate-fade-in" style="animation-delay: 0.2s;">
						...
						<label class="input-wrapper">
							...
							<input
								type="text"
								name="adres"
								placeholder="Bijv. Kerkstraat 80"
								required
								disabled={formState === 'loading'}
							/>
						</label>
					...
					<section class="formulier-sectie-full animate-fade-in" style="animation-delay: 0.4s;">
						...
						<fieldset class="radio-group">
							<legend style="font-family: var(--font-primary);">Soort deur<span>*</span></legend>
							<p class="help-text">Selecteer hier de deur van uw keuze</p>
							<div class="radio-options">
								{#each deurOpties as optie, index}
									<label 
										class="radio-label"
										style="animation-delay: {0.5 + index * 0.1}s; font-family: var(--font-primary); font-weight: 400;"
...
<style>
	...
	.success-icon-wrap {
		background: #22c55e;
		color: white;
		animation: successPulse 1.5s ease-out 2;
	}
	.error-icon-wrap {
		background: #ef4444;
		color: white;
	...
	.form-loading > *:not(.loading-overlay) {
		opacity: 0.35;
		filter: blur(1px);
		transition: all 0.3s ease;
	}
